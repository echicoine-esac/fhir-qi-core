...
In addition to (QI) Key Element extensions, each QI-Core profile identifies a primary code path. This primary code path provides the 
default filtering for a CQL expression. See Using [using-modelinfo](https://hl7.org/fhir/uv/cql/using-modelinfo.html#modelinfo-settings) 
section in [Using CQL with FHIR.](https://hl7.org/fhir/uv/cql/index.html)
